...
import { CheckCircleIcon, ExclamationCircleIcon, SparklesIcon, Bars3Icon, XMarkIcon } from "@heroicons/vue/24/outline";
          ...
          <div v-for="notification in notifications"
            ...
            <div class="p-4">
              <div class="flex items-start">
                <div class="flex-shrink-0">
                  <ExclamationCircleIcon v-if="notification.type === 'error'" class="h-6 w-6 text-red-400" aria-hidden="true" />
                ...
                <div class="ml-4 flex flex-shrink-0">
                  <button type="button" @click="close(notification.id)" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
